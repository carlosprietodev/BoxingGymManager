...
<div class="privacidad-container d-flex justify-content-center align-items-center">
  <div class="card card-privacidad shadow-sm">
    <h2 class="text-center text-danger fw-bold">Error 500. Disculpe las molestias.</h2>
    <div class="d-flex justify-content-center">
      <img src="${contexto}/Images/Error/error500.png" class="w-75" alt="error 500"/>
